...
const Contact: React.FC = () => {
  ...
  const notifySentForm: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    e.preventDefault();
    window.location.href = `mailto:pascalmartin973@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message)}`
  };
        ...
        <div className="flex flex-row justify-center items-start px-32 pt-32 mb-32 max-lg:flex-col max-lg:p-10">
          ...
          >
            ...
            <div className="privacy-checkbox flex gap-16">
              ...
              <p>
                {contactData.privacyOptIn.checkbox}
              </p>
            </div>
            <p>
              {contactData.privacyOptIn.description}
            </p>
            <Button
